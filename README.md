      ...
      >
        <title id="titleId">Diego &#193;lvarez Francos' GitHub Stats, Rank: C</title>
        <desc id="descId">Total Stars Earned: 0, Total Commits  : 33, Total PRs: 1, Total Issues: 1, Contributed to (last year): 0</desc>
        <style>
          .header {
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 245.45175285110992;
      }
    }
      ...
      <text
        ...
        class="header"
        data-testid="header"
      >Diego &#193;lvarez Francos' GitHub Stats</text>
    </g>
      </g>
