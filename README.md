      ...
      >
        <title id="titleId">Diego's GitHub Stats, Rank: C</title>
        <desc id="descId">Total Stars Earned: 0, Total Commits  : 123, Total PRs: 1, Total Issues: 1, Contributed to (last year): 0</desc>
        <style>
          .header {
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 242.97577554406718;
      }
    }
